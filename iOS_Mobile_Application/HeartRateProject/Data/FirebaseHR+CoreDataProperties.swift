...
//-DESCRIPTION--------------------------------------------------------------
//
//  FirebaseHR+CoreDataProperties.swift
//
//-DISCLAIMER---------------------------------------------------------------
...
extension FirebaseHR {

    @nonobjc public class func fetchRequest() -> NSFetchRequest<FirebaseHR> {
        return NSFetchRequest<FirebaseHR>(entityName: "FirebaseHR")
    }
