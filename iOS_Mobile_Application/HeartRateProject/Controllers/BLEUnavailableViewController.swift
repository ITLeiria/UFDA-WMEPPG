...
class BLEUnavailableViewController: UIViewController {
    ...
    @IBOutlet weak var lblBleTitle: UILabel!
    @IBOutlet weak var lblBleDescription: UILabel!
    @IBOutlet weak var imgBleIcon: UIImageView!
    
    override func viewDidLoad() {
        lblBleTitle.text = "BLE Unavailable"
        lblBleDescription.text = "Please turn Bluetooth on to use the app."
    }
}
